 ...
 */
function login() {
    return location.href = "http://localhost:9009/page/login";
}
function regist() {
    return location.href = "http://localhost:9009/page/register";
}
...
function search(a) {
    var b = "http://localhost:9006/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
